                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="<?php echo base_url()?>home/update" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="fallback">
                                                    ...
                                                    <input type="hidden" name="old_image" id="old_image" value="<?php echo $edit_data->blog_image; ?>"/>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control" id="blog_title" name="blog_title" placeholder="Enter your Blog content" value="<?php echo $edit_data->blog_title?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">   
                                            <div class="col-lg-12">
                                                <label class="col-form-label" for="val-email">Blog Heading</label>
                                                <input type="text" class="form-control" id="blog_heading" name="blog_heading" placeholder="Enter your Blog heading" value="<?php echo $edit_data->blog_heading?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                <label class="col-form-label" for="content">Blog Post Content</label>
                                                <textarea class="form-control" id="blog_content" name="blog_content" rows="5" placeholder="Enter your Blog content"><?php echo $edit_data->blog_content?></textarea>
                                            </div>
                                        </div>   
                                        <!-- <div class="form-group row">
                                            <div class="col-lg-12">
