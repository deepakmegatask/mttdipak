              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php echo $admin_details->mobileno;?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " href="<?php echo base_url();?>login\editprofile">Edit Profile</a>
                    </div>
                  </div>
                </div>
              </div>
...
<script type="text/javascript">
  setTimeout(function(){ $('#errors').hide(1000); },3000);
</script>
    <script
